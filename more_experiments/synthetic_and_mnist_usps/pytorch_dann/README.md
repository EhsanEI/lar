This code is based on a previous implementation by https://github.com/NaJaeMin92/pytorch_DANN (This is a public implementation on Github. The repo does not belong to the paper authors.)
